...
import (
	...
	etcdv1beta3 "github.com/coreos/etcd-operator/pkg/apis/etcd/v1beta3"
	...
	v1beta3 "github.com/coreos/etcd-operator/pkg/generated/listers/etcd/v1beta3"
...
type EtcdClusterInformer interface {
	...
	Lister() v1beta3.EtcdClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1beta3().EtcdClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1beta3().EtcdClusters(namespace).Watch(options)
			},
		},
		&etcdv1beta3.EtcdCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdv1beta3.EtcdCluster{}, f.defaultInformer)
}

func (f *etcdClusterInformer) Lister() v1beta3.EtcdClusterLister {
	return v1beta3.NewEtcdClusterLister(f.Informer().GetIndexer())
}
