...
type EtcdBackupInformer interface {
	...
	Lister() v1beta3.EtcdBackupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1beta3().EtcdBackups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1beta3().EtcdBackups(namespace).Watch(options)
			},
		},
		&etcdv1beta3.EtcdBackup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdv1beta3.EtcdBackup{}, f.defaultInformer)
}

func (f *etcdBackupInformer) Lister() v1beta3.EtcdBackupLister {
	return v1beta3.NewEtcdBackupLister(f.Informer().GetIndexer())
}
