...
type EtcdRestoreInformer interface {
	...
	Lister() v1beta3.EtcdRestoreLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1beta3().EtcdRestores(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1beta3().EtcdRestores(namespace).Watch(options)
			},
		},
		&etcdv1beta3.EtcdRestore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdRestoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdv1beta3.EtcdRestore{}, f.defaultInformer)
}

func (f *etcdRestoreInformer) Lister() v1beta3.EtcdRestoreLister {
	return v1beta3.NewEtcdRestoreLister(f.Informer().GetIndexer())
}
