...
type EtcdRestoreLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta3.EtcdRestore, err error)
...
// List lists all EtcdRestores in the indexer.
func (s *etcdRestoreLister) List(selector labels.Selector) (ret []*v1beta3.EtcdRestore, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta3.EtcdRestore))
	})
	return ret, err
}
...
type EtcdRestoreNamespaceLister interface {
	...
	Get(name string) (*v1beta3.EtcdRestore, error)
...
// List lists all EtcdRestores in the indexer for a given namespace.
func (s etcdRestoreNamespaceLister) List(selector labels.Selector) (ret []*v1beta3.EtcdRestore, err error) {
...
// Get retrieves the EtcdRestore from the indexer for a given namespace and name.
func (s etcdRestoreNamespaceLister) Get(name string) (*v1beta3.EtcdRestore, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta3.Resource("etcdrestore"), name)
	}
	return obj.(*v1beta3.EtcdRestore), nil
}
