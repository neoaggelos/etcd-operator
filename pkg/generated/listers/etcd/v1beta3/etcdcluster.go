...
type EtcdClusterLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta3.EtcdCluster, err error)
...
// List lists all EtcdClusters in the indexer.
func (s *etcdClusterLister) List(selector labels.Selector) (ret []*v1beta3.EtcdCluster, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta3.EtcdCluster))
	})
	return ret, err
}
...
type EtcdClusterNamespaceLister interface {
	...
	Get(name string) (*v1beta3.EtcdCluster, error)
...
// List lists all EtcdClusters in the indexer for a given namespace.
func (s etcdClusterNamespaceLister) List(selector labels.Selector) (ret []*v1beta3.EtcdCluster, err error) {
...
// Get retrieves the EtcdCluster from the indexer for a given namespace and name.
func (s etcdClusterNamespaceLister) Get(name string) (*v1beta3.EtcdCluster, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta3.Resource("etcdcluster"), name)
	}
	return obj.(*v1beta3.EtcdCluster), nil
}
