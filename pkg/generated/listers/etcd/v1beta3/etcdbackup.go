...
type EtcdBackupLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta3.EtcdBackup, err error)
...
// List lists all EtcdBackups in the indexer.
func (s *etcdBackupLister) List(selector labels.Selector) (ret []*v1beta3.EtcdBackup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta3.EtcdBackup))
	})
	return ret, err
}
...
type EtcdBackupNamespaceLister interface {
	...
	Get(name string) (*v1beta3.EtcdBackup, error)
...
// List lists all EtcdBackups in the indexer for a given namespace.
func (s etcdBackupNamespaceLister) List(selector labels.Selector) (ret []*v1beta3.EtcdBackup, err error) {
...
// Get retrieves the EtcdBackup from the indexer for a given namespace and name.
func (s etcdBackupNamespaceLister) Get(name string) (*v1beta3.EtcdBackup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta3.Resource("etcdbackup"), name)
	}
	return obj.(*v1beta3.EtcdBackup), nil
}
