...
func (c *FakeEtcdClusters) Get(name string, options v1.GetOptions) (result *v1beta3.EtcdCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(etcdclustersResource, c.ns, name), &v1beta3.EtcdCluster{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta3.EtcdCluster), err
}

// List takes label and field selectors, and returns the list of EtcdClusters that match those selectors.
func (c *FakeEtcdClusters) List(opts v1.ListOptions) (result *v1beta3.EtcdClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(etcdclustersResource, etcdclustersKind, c.ns, opts), &v1beta3.EtcdClusterList{})
	...
	list := &v1beta3.EtcdClusterList{ListMeta: obj.(*v1beta3.EtcdClusterList).ListMeta}
	for _, item := range obj.(*v1beta3.EtcdClusterList).Items {
...
func (c *FakeEtcdClusters) Create(etcdCluster *v1beta3.EtcdCluster) (result *v1beta3.EtcdCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(etcdclustersResource, c.ns, etcdCluster), &v1beta3.EtcdCluster{})
...
func (c *FakeEtcdClusters) Update(etcdCluster *v1beta3.EtcdCluster) (result *v1beta3.EtcdCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(etcdclustersResource, c.ns, etcdCluster), &v1beta3.EtcdCluster{})
...
func (c *FakeEtcdClusters) UpdateStatus(etcdCluster *v1beta3.EtcdCluster) (*v1beta3.EtcdCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(etcdclustersResource, "status", c.ns, etcdCluster), &v1beta3.EtcdCluster{})
...
func (c *FakeEtcdClusters) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(etcdclustersResource, c.ns, name), &v1beta3.EtcdCluster{})
...
func (c *FakeEtcdClusters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta3.EtcdClusterList{})
	return err
}

// Patch applies the patch and returns the patched etcdCluster.
func (c *FakeEtcdClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta3.EtcdCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(etcdclustersResource, c.ns, name, types.ApplyPatchType, data, subresources...), &v1beta3.EtcdCluster{})
