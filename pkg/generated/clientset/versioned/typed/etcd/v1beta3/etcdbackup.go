...
type EtcdBackupInterface interface {
	Create(*v1beta3.EtcdBackup) (*v1beta3.EtcdBackup, error)
	Update(*v1beta3.EtcdBackup) (*v1beta3.EtcdBackup, error)
	UpdateStatus(*v1beta3.EtcdBackup) (*v1beta3.EtcdBackup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta3.EtcdBackup, error)
	List(opts v1.ListOptions) (*v1beta3.EtcdBackupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta3.EtcdBackup, err error)
	EtcdBackupExpansion
}
...
func newEtcdBackups(c *EtcdV1beta3Client, namespace string) *etcdBackups {
	return &etcdBackups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *etcdBackups) Get(name string, options v1.GetOptions) (result *v1beta3.EtcdBackup, err error) {
	result = &v1beta3.EtcdBackup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *etcdBackups) List(opts v1.ListOptions) (result *v1beta3.EtcdBackupList, err error) {
	result = &v1beta3.EtcdBackupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("etcdbackups").
...
func (c *etcdBackups) Create(etcdBackup *v1beta3.EtcdBackup) (result *v1beta3.EtcdBackup, err error) {
	result = &v1beta3.EtcdBackup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("etcdbackups").
...
func (c *etcdBackups) Update(etcdBackup *v1beta3.EtcdBackup) (result *v1beta3.EtcdBackup, err error) {
	result = &v1beta3.EtcdBackup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdbackups").
...
func (c *etcdBackups) UpdateStatus(etcdBackup *v1beta3.EtcdBackup) (result *v1beta3.EtcdBackup, err error) {
	result = &v1beta3.EtcdBackup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdbackups").
...
func (c *etcdBackups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta3.EtcdBackup, err error) {
	result = &v1beta3.EtcdBackup{}
