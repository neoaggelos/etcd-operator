...
type EtcdClusterInterface interface {
	Create(*v1beta3.EtcdCluster) (*v1beta3.EtcdCluster, error)
	Update(*v1beta3.EtcdCluster) (*v1beta3.EtcdCluster, error)
	UpdateStatus(*v1beta3.EtcdCluster) (*v1beta3.EtcdCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta3.EtcdCluster, error)
	List(opts v1.ListOptions) (*v1beta3.EtcdClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta3.EtcdCluster, err error)
...
func newEtcdClusters(c *EtcdV1beta3Client, namespace string) *etcdClusters {
	return &etcdClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *etcdClusters) Get(name string, options v1.GetOptions) (result *v1beta3.EtcdCluster, err error) {
	result = &v1beta3.EtcdCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *etcdClusters) List(opts v1.ListOptions) (result *v1beta3.EtcdClusterList, err error) {
	result = &v1beta3.EtcdClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("etcdclusters").
...
func (c *etcdClusters) Create(etcdCluster *v1beta3.EtcdCluster) (result *v1beta3.EtcdCluster, err error) {
	result = &v1beta3.EtcdCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("etcdclusters").
...
func (c *etcdClusters) Update(etcdCluster *v1beta3.EtcdCluster) (result *v1beta3.EtcdCluster, err error) {
	result = &v1beta3.EtcdCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdclusters").
...
func (c *etcdClusters) UpdateStatus(etcdCluster *v1beta3.EtcdCluster) (result *v1beta3.EtcdCluster, err error) {
	result = &v1beta3.EtcdCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("etcdclusters").
...
func (c *etcdClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta3.EtcdCluster, err error) {
	result = &v1beta3.EtcdCluster{}
